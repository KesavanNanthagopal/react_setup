...
import OrderDetailsPopup from "../component/OrderPopup";
    ...
    return (
        <div className="container-fluid py-4 order-row order-overall-container">
            <div className="row order-row">
                <div className="col-12 col-md-4 first-container">
                    ...
                    <div className={`${isMobilePage?"order-mobile-height":"order-web-height"} overflow-auto order-list`}>
                        {[...Array(5)].map((_, index) => (
                            <div
                                key={index}
                                onClick={() => handleOrderClick(index)}
                                className={`order-item ${activeOrderIndex === index ? "active" : ""}`}
                                style={{
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-4 text-end" style={{ color: "#ff8c00", fontWeight: "bold" }}>
                                ...
                                <div className="row p-4">
                                    <div className="order-details-mid-container">
                                        <div className="row">
                                            ...
                                            <div className="col-12 col-sm-4 ms-auto d-flex justify-content-end">
            ...
            {
                showOrderPopup && <OrderDetailsPopup onClose={onClose} show={showOrderPopup}/>
            }
        </div>
    );
};
